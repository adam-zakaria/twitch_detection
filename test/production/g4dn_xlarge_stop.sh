...
ssh "$INSTANCE_NAME" "rm -rf /home/ubuntu/Code/twitch_detection && git clone git@github.com:adam-zakaria/twitch_detection.git /home/ubuntu/Code/twitch_detection && cd /home/ubuntu/Code/twitch_detection/test/production && python log_test.py"
