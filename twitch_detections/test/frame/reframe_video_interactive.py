"""
This script allows you to select a region of interest (ROI) in a video and then
crop the video to that ROI.

It uses OpenCV to display the video and a trackbar to navigate through the frames.

It then uses the selected ROI to crop the video and save it to a new file.
"""
